...
## NAVODILA
Če želite sami pridobiti podatke iz interneta in jih pretvoriti v csv datoteko, samo poženite `main.py`. Če s tem ne želite naresti html datotek za strani seznama, ko v terminalu poženete `main.py`, zraven dopišite ne_poberi.<br>
Analiza filmov je dostopna v datoteki `analiza.ipynb`.
## PRIDOBIVANJE PODATKOV
- V datoteki `dobivanje_spletnih_strani.py` je funkcija, ki iz vseh strani seznama iz interneta shrani html datoteko.
